...
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   KC_T,    KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LGUI,
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
...
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   KC_TRNS, KC_GRV,  KC_SLSH, KC_ASTR, KC_UNDS, E_EUR,                     E_NN,    KC_1,    KC_2,    KC_3,    FUNCL,   KC_LALT,
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
...
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   KC_TRNS, KC_ESC,  KC_LEFT, KC_DOWN, KC_RGHT, VD_R,                      KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, KC_COLN,  KC_TRNS,
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   KC_TRNS, FUNCL,   KC_PGDN, E_CC,    KC_PGUP, KC_DEL,                    KC_BSLS, KC_PIPE, KC_LABK, KC_RABK, KC_QUES,  KC_LALT,
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
                                       KC_TRNS, KC_TRNS, RAISE,   LOWER,   KC_TRNS, KC_TRNS
//                                    +--------+--------+--------+--------+--------+--------+
  ),
...
//         +--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+
           QK_BOOT,OSM(MOD_LSFT),OSM(MOD_LALT),OSM(MOD_RALT),OSM(MOD_RSFT),KC_F12,  KC_F7,   KC_F8,   KC_F9,   QK_BOOT,    
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   KC_TRNS,XXXXXXX,OSM(MOD_LCTL),OSM(MOD_LGUI),OSM(MOD_RGUI),OSM(MOD_RCTL),KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_F13,  KC_TRNS,
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   KC_TRNS, KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_TRNS, KC_LALT,
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
                                       KC_TRNS, KC_TRNS, RAISE,   LOWER,   KC_TRNS, KC_TRNS
//                                    +--------+--------+--------+--------+--------+--------+
  ),
...
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   KC_TRNS, KC_NUBS, E_ATI,   E_DEG,   D_SIL,   KC_KB_MUTE,                KC_MNXT, KVM1,    KVM2,    XXXXXXX, E_IQM,   KC_TRNS,
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
                                       KC_TRNS, KC_TRNS, RAISE,   LOWER,   KC_TRNS, KC_TRNS
//                                    +--------+--------+--------+--------+--------+--------+
  ),
